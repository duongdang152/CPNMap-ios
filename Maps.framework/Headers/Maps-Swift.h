...
/// Geo-Category code
@property (nonatomic, copy) NSString * _Nullable geoCategory;
/// Parent category
...
@property (nonatomic, weak) id <SDKSetupDelegate> _Nullable setupDelegate;
...
- (void)stopNavigation;
- (enum NavigationMode)getOngoingNavigationMode SWIFT_WARN_UNUSED_RESULT;
- (NavigationInfo * _Nullable)getOngoingNavigationInfo SWIFT_WARN_UNUSED_RESULT;
- (CTLSection * _Nullable)getCurrentSection SWIFT_WARN_UNUSED_RESULT;
- (CTLLevel * _Nullable)getCurrentLevel SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
/// [DEPRECATED] Callback triggered when the navigation started
...
/// [DEPRECATED] Callback on touch up of the navigate button
- (void)willStartNavigationWithRequest:(CTLPathRequest * _Nonnull)request;
/// Callback after a POI to POI path is successfully triggered
- (void)didStartPoiToPoiNavigationWithOrigin:(CTLPOI * _Nonnull)origin destination:(CTLPOI * _Nonnull)destination disabledPath:(BOOL)disabledPath;
/// Callback after a POI to POI path fails to be triggered
- (void)poiToPoiNavigationDidFailedWithOrigin:(CTLPOI * _Nonnull)origin destination:(CTLPOI * _Nonnull)destination disabledPath:(BOOL)disabledPath;
/// Callback after a path from current location to destination POI is successfully triggered
- (void)didStartCurrentLocationToPoiNavigationWithDestination:(CTLPOI * _Nonnull)destination disabledPath:(BOOL)disabledPath;
/// Callback after a path from current location to destination POI fails to be triggered
- (void)currentLocationToPoiNavigationDidFailedWithDestination:(CTLPOI * _Nonnull)destination disabledPath:(BOOL)disabledPath;
/// Callback when user arrives at destination POI after requesting a path from current location to that POI
- (void)currentLocationToPoiNavigationDidArriveWithDestination:(CTLPOI * _Nonnull)destination disabledPath:(BOOL)disabledPath;
/// Callback when the ‘Navigate’ button is tapped in the default Preview UI
- (void)didTapNavigateButtonOnPreviewWithPoi:(CTLPOI * _Nonnull)poi;
@end




/// General information about a navigation route
SWIFT_CLASS("_TtC4Maps14NavigationInfo")
@interface NavigationInfo : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, NavigationMode, closed) {
  NavigationModeNone = 0,
  NavigationModePoiToPoi = 1,
  NavigationModeCurrentLocationToPoi = 2,
};
...
SWIFT_PROTOCOL("_TtP4Maps16SDKSetupDelegate_")
@protocol SDKSetupDelegate
- (void)sdkSetupWhenConfigChange;
- (void)sdkSetupInProgressWithPortionCompleted:(float)portionCompleted;
- (void)sdkSetupDidFinishWithSuccess:(BOOL)success;
@end
...
+ (UIColor * _Nonnull)appTheme SWIFT_WARN_UNUSED_RESULT;
+ (UIColor * _Nonnull)appInvertedTheme SWIFT_WARN_UNUSED_RESULT;
+ (CGFloat)getFontSizeMultiplier SWIFT_WARN_UNUSED_RESULT;
+ (UIColor * _Nonnull)mapBackgroundColor SWIFT_WARN_UNUSED_RESULT;
+ (UIColor * _Nonnull)previewBackgroundColor SWIFT_WARN_UNUSED_RESULT;
+ (UIColor * _Nonnull)previewTextColor SWIFT_WARN_UNUSED_RESULT;
+ (UIColor * _Nonnull)userLocationColor SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
